...
<div class="card-block">
	...
	<form action="{{ route('etudiants.update', $etudiant) }}" method="POST">
		...
		<div class="form-group {{ $errors->has('matricule') ? 'has-danger' : '' }}">
			...
			<input type="text" name="matricule" id="matricule" class="form-control" required="required" value="{{ $etudiant->matricule }}">
		...
		<div class="form-group {{ $errors->has('nom') ? 'has-danger' : '' }}">
			...
			<input type="text" name="nom" id="nom" class="form-control" required="required" value="{{ $etudiant->nom }}">
		...
		<div class="form-group {{ $errors->has('prenom') ? 'has-danger' : '' }}">
			...
			<input type="text" name="prenom" id="prenom" class="form-control" required="required" value="{{ $etudiant->prenom }}">
		...
		<div class="form-group {{ $errors->has('date_naissance') ? 'has-danger' : '' }}">
			...
			<input type="date" name="date_naissance" id="date_naissance" class="form-control" required="required" value="{{ $etudiant->date_naissance }}">
			{!! $errors->first('date_naissance', '<span class="help-block form-control-feedback">:message</span>') !!}
		</div>

		<div class="form-group {{ $errors->has('email') ? 'has-danger' : '' }}">
			<label for="email" class="control-label">Email</label>
			<input type="email" name="email" id="email" class="form-control" required="required" value="{{ $etudiant->email }}">
		...
		<div class="form-group {{ $errors->has('password') ? 'has-danger' : '' }}">
			...
			<input type="password" name="password" id="confirm_password" class="form-control" required="required" value="">
			{!! $errors->first('password', '<span class="help-block form-control-feedback">:message</span>') !!}
		</div>
