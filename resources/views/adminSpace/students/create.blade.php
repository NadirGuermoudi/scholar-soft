...
<div class="card-block">
	...
	<form action="{{ route('etudiants.store') }}" method="POST">
		...
		<div class="form-group {{ $errors->has('matricule') ? 'has-danger' : '' }}">
			...
			<input type="text" name="matricule" id="matricule" class="form-control" required="required" value="{{ old('matricule') }}">
		...
		<div class="form-group {{ $errors->has('prenom') ? 'has-danger' : '' }}">
			...
			<input type="text" name="prenom" id="prenom" class="form-control" required="required" value="{{ old('prenom') }}">
		...
		<div class="form-group {{ $errors->has('password') ? 'has-danger' : '' }}">
			...
			<input type="password" name="password" id="password" class="form-control" required="required" value="{{ old('password') }}">
			{!! $errors->first('password', '<span class="help-block form-control-feedback">:message</span>') !!}
		</div>

		<div class="form-group {{ $errors->has('password') ? 'has-danger' : '' }}">
			<label for="password" class="control-label">Confirm password</label>
			<input type="password" name="password" id="confirm_password" class="form-control" required="required" value="{{ old('password') }}">
			{!! $errors->first('password', '<span class="help-block form-control-feedback">:message</span>') !!}
		</div>
