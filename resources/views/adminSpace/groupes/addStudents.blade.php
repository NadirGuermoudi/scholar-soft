			...
			<div class="col-12">
				<div class="card">
					<div class="card-block">
						...
						<button type="button" class="btn  btn-success btn-block btn-md" data-toggle="modal"
										data-target="#add-students">
							<i class="fa fa-plus"></i> Ajouter un ou plusieurs etudiants via un fichier excel <i
						...
						<table id="example23" class="display nowrap table table-hover table-striped table-bordered"
							...
							@foreach($etudiants as $etudiant)
								<tr>
									...
									<td>
										<a href="{{ route('groupes.addStudent', compact('groupe','etudiant')) }}"
											 class="btn btn-outline-success"><i class="fa fa-plus"></i></a>
									</td>
								</tr>
							@endforeach
							</tbody>
