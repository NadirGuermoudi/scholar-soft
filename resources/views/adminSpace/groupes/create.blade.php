...
<div class="card-block">
	...
	<form action="{{ route('groupes.store') }}" method="POST" enctype="multipart/form-data">
		...
		<div class="form-group {{ $errors->has('specialite') ? 'has-danger' : '' }}">
			...
			<input type="text" name="specialite" id="specialite" class="form-control" required="required" value="{{ old('specialite') }}">
		...
		<div class="form-group {{ $errors->has('numero') ? 'has-danger' : '' }}">
			...
			<input type="number" name="numero" id="numero" class="form-control" required="required" value="{{ old('numero') }}">
		...
		<div class="form-group {{ $errors->has('annee') ? 'has-danger' : '' }}">
			...
			<input type="text" name="annee" id="annee" class="form-control" required="required" value="{{ old('annee') }}">
		...
		<div class="form-group {{ $errors->has('etudiants') ? 'has-danger' : '' }}">
			<label for="etudiants" class="control-label">Liste des etudiants (Excel : matricule * | nom * | prenom * | date_naissance | email) <a id="helpme"><i class="fas fa-info-circle"></i><img id="excel_help" src="{{asset('images/other-images/excel_data_example.PNG')}}"></a></label>
			<input type="file" name="etudiants" id="etudiants" class="form-control" required="required" value="{{ old('etudiants') }}">
