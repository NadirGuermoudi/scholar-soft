	    ...
	    <div class="card-block">
			...
			<div class="tab-content tabcontent-border p-20" id="myTabContent">
				...
				<div role="tabpanel" class="tab-pane fade show active" id="home5" aria-labelledby="home-tab"> --}}
					...
					<form class="well form-horizontal" method="POST" action="{{route('salles.update', $salle->id)}}" id="contact_form" enctype="multipart/form-data">
						@csrf
						@method('PUT')	
						...
						<div class="form-group">  
							...
							name="nom" value="{{$salle->nom}}">
							</div>
	                           
							<div class="col-md-12 m-b-20">
								<input type="text" class="form-control" placeholder="capicité"
							name="capacite" value="{{$salle->capacite}}">
							</div>          		  	
