		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<br>
					{{ $paquet->date_limite_correcteur1 }} @if($paquet->correcteur1_rendu) <i class="fas fa-check-circle text-success"></i> @else <i class="fas fa-sync-alt text-warning"></i> @endif
					@endif
				</td>
				<td>
					...
					<br>
					{{ $paquet->date_limite_correcteur2 }} @if($paquet->correcteur2_rendu) <i class="fas fa-check-circle text-success"></i> @else <i class="fas fa-sync-alt text-warning"></i> @endif
					@endif
				</td>
				<td>
					...
					<br>
					{{ $paquet->date_limite_correcteur3 }} @if($paquet->correcteur3_rendu) <i class="fas fa-check-circle text-success"></i> @else <i class="fas fa-sync-alt text-warning"></i> @endif
					@endif
				</td>

				<td>
					@if($paquet->responsable_rendu)
						<button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#delivered-paquet">
					...
					<button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete-paquet{{$paquet->id}}">
